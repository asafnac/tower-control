  ...
  stages: [
    ...
    },
    {
      ...
      questions: [
        ...
        { type: 'addition',    a: 7,  b: 6,  result: 13, hint: 'dots', radioText: 'מִגְדַּל הַפִּיקּוּחַ! {a} מְטוֹסִים מִמִּזְרָח וְ-{b} מִמַּעֲרָב. כַּמָּה מְטוֹסִים סַךְ הַכֹּל?' },
        ...
        { type: 'addition',    a: 6,  b: 8,  result: 14, hint: 'dots', radioText: 'מִגְדַּל הַפִּיקּוּחַ, {a} מְטוֹסִים בְּצַד יָמִין, {b} בְּצַד שְׂמֹאל. כַּמָּה מְטוֹסִים סַךְ הַכֹּל?' },
        { type: 'addition',    a: 9,  b: 6,  result: 15, hint: 'dots', radioText: 'מִגְדַּל הַפִּיקּוּחַ! {a} מְטוֹסִים וְעוֹד {b}. כַּמָּה מְטוֹסִים סַךְ הַכֹּל?' },
